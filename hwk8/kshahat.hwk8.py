...
h1 = 0.2
x = 0.2
# Using the first central difference approximation equation with 0.2 stepsize
...
#
h2 = h1 / 2.0
# Using the first central difference approximation equation with 0.1 stepsize
...
p = 2.0
# Using the REF with h2 being 0.5 * h1
