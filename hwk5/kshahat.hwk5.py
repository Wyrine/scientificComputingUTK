...
#
#Getting the curvature of the x and y data on a log scale
...
for Re in Re_array:
  #calling the evalSpline method on the log data with the curvature
  #the log of Reynolds number
...
# Generate curvatures here
#
#Getting the curvature of the t and m data
...
# Use this print statement in your loop ...
for temp in T_array:
  #calling the evalSpline method on the t and m data with the
  #curvature of the t and m data as well as the current temperature
